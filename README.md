...
This package provides **CoinDCX exchange plugin for bt_api framework** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **COINDCX** exchange.
...
```python
from bt_api_coindcx import CoindcxApi

# Initialize
feed = CoindcxApi(api_key="your_key", secret="your_secret")
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_coindcx |
| Issue Tracker | https://github.com/cloudQuant/bt_api_coindcx/issues |
...
```
bt_api_coindcx/
├── src/bt_api_coindcx/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_coindcx/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **CoinDCX exchange plugin for bt_api framework**。它提供了与 **COINDCX** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_coindcx |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_coindcx/issues) 反馈问题
