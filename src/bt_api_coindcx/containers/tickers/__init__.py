...
class CoinDCXTickerData(TickerData):
    """Class CoinDCXTickerData"""
    def __init__(
        self,
    ...
    def init_data(self) -> CoinDCXTickerData:
        """init_data method"""
        ...
        if isinstance(data, dict):
            ...
            self.last_price = from_dict_get_float(data, "last_price")
...
class CoinDCXRequestTickerData(CoinDCXTickerData):
    """Class CoinDCXRequestTickerData"""
    pass


class CoinDCXWssTickerData(CoinDCXTickerData):
    """Class CoinDCXWssTickerData"""
    pass


__all__ = ["CoinDCXRequestTickerData", "CoinDCXTickerData", "CoinDCXWssTickerData"]
