...
class CoinDCXRequestDataSpot(CoinDCXRequestData):
    ...
    def _get_tick_normalize_function(input_data, extra_data):
        ...
        target_symbol = extra_data.get("symbol_name", "") if extra_data else ""
    ...
    def _get_kline(self, symbol, period, count=20, extra_data=None, **kwargs):
        ...
        path = "GET /market_data/candles"
        period_str = self._params.kline_periods.get(period, period)
        params = {"pair": symbol, "interval": period_str}
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _get_exchange_info(self, extra_data=None, **kwargs):
        ...
        path = "GET /exchange/v1/markets_details"
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _get_account(self, extra_data=None, **kwargs):
        ...
        path = "POST /exchange/v1/users/info"
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _get_balance(self, symbol=None, extra_data=None, **kwargs):
        """Get account balance."""
        path = "POST /exchange/v1/users/balances"
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _make_order(
        ...
        **kwargs,
        ...
        """Prepare order."""
        path = "POST /exchange/v1/orders/create"
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _cancel_order(self, symbol, order_id, extra_data=None, **kwargs):
        """Cancel order."""
        path = "POST /exchange/v1/orders/cancel"
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _query_order(self, symbol, order_id, extra_data=None, **kwargs):
        """Query order."""
        path = "POST /exchange/v1/orders/status"
        if extra_data is None:
            extra_data = {}
        extra_data.update(
            {
    ...
    def _get_open_orders(self, symbol=None, extra_data=None, **kwargs):
        """Get open orders."""
        path = "POST /exchange/v1/orders/active_orders"
        params: dict[str, Any] = {}
        if symbol:
